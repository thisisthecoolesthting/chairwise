...
2. **Average build** (5’4” to 5’9”, 120-160 lbs): Moderate adjustments fit most but variations still matter.
3. **Tall frames** (6’0” and above): Require longer seat depths and higher lumbar support.
4. **Stocky builds** (160+ lbs, wider shoulders): Need wider seats, stronger lumbar, and sturdier armrest adjustment.
5. **Plus-size users** (overweight or larger frames): Larger seat dimensions, strong weight capacity, and broad adjustment range necessary, with particular attention on cushion firmness and pressure relief.
